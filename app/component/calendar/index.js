...
class Calendar extends Component {
  ...
  _handleDayInteraction(date, interaction) {
    ...
    if (!(minDate && !dateutils.isGTE(day, minDate)) &&
      ...
      const shouldUpdateMonth = this.props.disableMonthChange === undefined ||
  ...
  isDateNotInTheRange = (minDate, maxDate, date) => {
    return (minDate && !dateutils.isGTE(date, minDate)) ||
  ...
  render() {
    ...
    if (current) {
      const lastMonthOfDay = current.clone().
          addMonths(1, true).
          setDate(1).
          addDays(-1).
          toString('yyyy-MM-dd')
        ...
        <GestureComponent {...gestureProps}>
          ...
          >
            <CalendarHeader
                ...
                monthFormat={this.props.monthFormat || 'MMM yyyy'}
